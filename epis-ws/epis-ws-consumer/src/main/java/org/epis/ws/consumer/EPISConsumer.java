...
import org.epis.ws.consumer.security.EPISConsumerUTCallbackHandler;
import org.epis.ws.consumer.service.core.EPISConsumerService;
...
public class EPISConsumer {
	...
	public void start(String command) {
		...
		logger.debug("==CHANGED PROPERTIES VALUE : {}",agentProp.getProperty(PropertyEnum.SCHEDULE_CMD.getKey() + "config"));
	}
